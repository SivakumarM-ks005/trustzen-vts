...
@Component({
  selector: 'app-dialog-rfq-extension',
  standalone: true,
  ...
  templateUrl: './dialog-rfq-extension.component.html',
  styleUrl: './dialog-rfq-extension.component.scss'
})
export class DialogRfqExtensionComponent {
