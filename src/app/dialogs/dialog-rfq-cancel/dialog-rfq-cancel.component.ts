...
@Component({
  selector: 'app-dialog-rfq-cancel',
  standalone: true,
  ...
  templateUrl: './dialog-rfq-cancel.component.html',
  styleUrl: './dialog-rfq-cancel.component.scss'
})
export class DialogRfqCancelComponent {
