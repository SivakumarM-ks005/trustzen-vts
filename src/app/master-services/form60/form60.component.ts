...
@Component({
  selector: 'app-form60',
  standalone: true,
  imports: [MatDialogTitle,MatTabsModule, UpperCasePipe, OnlyAllowedInputDirective, MatIconButton, MatDialogClose, MatTooltip,  MatInputModule, MatIconModule, MatButtonModule, CdkScrollable, MatDialogContent, FormsModule, ReactiveFormsModule, 
  ...
  styleUrl: './form60.component.scss'
})
export class Form60Component {
